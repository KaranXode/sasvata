    ...
    <>
      <div className="home-wrapper relative">
        <div className="absolute z-[1] top-0 inset-x-0">
          <Navbar navStyle="text-white" />
        </div>
        <div>
          <img src="https://images.pexels.com/photos/1458694/pexels-photo-1458694.jpeg" alt="img" className="w-full h-screen object-cover" />
        </div>
        <div className="absolute  -translate-x-2/4 -translate-y-2/4 text-center left-2/4 top-2/4 text-white w-full">
          <h1 className="text-[24px] md:text-4xl lg:text-6xl font-semibold">
            Sasvata
          </h1>
