    ...
    return (
        <div className="p-6 lg:px-10 lg:py-20">
            <div className="flex gap-3  sectionOne">
                <div >
                    <Image src={truckImg} alt="img" className="w-auto h-auto md:w-[276px] lg:h-[400px]" />
                </div>
                <div>
                    <Image src={appleImg} alt="img" className="w-auto h-auto md:w-[444px] lg:h-[457px]" />
                </div>
                <div className="flex-[50%]  lg:pl-8 relative">
                    <Heading title="About Sasvata" className="mb-6"/>
                    <p className="mb-3 text-[#808080] text-[14px] lg:text-[16px]">Sasvata offers the 'Best of Dry Food Powders'. It was Rajeswari Pagadala and Mounika Kola who started the company in Nellore,
                    ...
                    <p className="mb-3 text-[#808080] text-[14px] lg:text-[16px]">As of today, most of our products are sold through wholesale orders, but we also offer some non-wholesale purchases. In spite of
                ...
                <Link href="/pages/about">    <Button size="large" variant="primary" label="Check More" icon={<FaArrowRightLong />}  /></Link>
                    </div>
                </div>
